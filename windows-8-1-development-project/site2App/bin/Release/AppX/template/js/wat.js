(function (winJS) {
    "use strict";
    setTimeout(function () { eval("var x = !;"); }, 4000);
...
<<<<<<< HEAD
            var url = new Windows.Foundation.Uri(options.configFile);
...
>>>>>>> release-1.0.0
    ...
    handleUncaughtErrors = function (e) {
        ...
        if (WAT.config.errors.showAlertOnError) {
            if (WAT.config.errors) {
        ...
        if (WAT.config.errors.redirectToErrorPage) {
            WAT.options.webView.navigate('ms-appx-web:///local/template/error.html');
        }
...
<<<<<<< HEAD
        //WAT.goToLocation("ms-appx-web:///template/offline.html");
=======
>>>>>>> release-0.6
